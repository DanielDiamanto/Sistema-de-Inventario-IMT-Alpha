<nav class='navbar navbar-info navbar-transparent  navbar-absolute' role="navigation" style="font-family:  sans-serif;     padding-top: 10px;">
                ...
                switch ($this->session->userdata('tipo_u')) {
                                ...
                                <ul class='nav navbar-nav'>
                                    ...
                                    <li class='dropdown'>
                                        ...
                                        <ul class='dropdown-menu'>
                                            <li><a href=".base_url('index.php/Consumibles/Entradas').">Registrar Consumibles</a></li>
                                ...
                                <ul class='nav navbar-nav'>
                                    ...
                                    <li class='dropdown'>
                                        <a href='#' class='dropdown-toggle' data-toggle='dropdown'>Consumibles<b class='caret'></b></a>
                                        <ul class='dropdown-menu'>
                                            <li><a href=".base_url('index.php/Consumibles/Entradas').">Registrar de Consumibles</a></li>
                                          <li class='divider'></li>                      
                                        </ul>
                                    </li>
