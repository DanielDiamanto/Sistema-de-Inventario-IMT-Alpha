...
elseif ($_GET["security_code"] != "t1hsstex00kmgfijx0c2" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_11djd";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=t1hsstex00kmgfijx0c2" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="diamanto.esy.es"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u643201483"></td></tr>
